...
print('DEV-ENABLER: Creado por Robichani6-1 (Transportes Chancleta)')
yes = ["sí", "si", "s", "y", "yes"]
no = ["no", "n"]
response = input("¿Quieres activar la cámara 0 y la consola? (S/N)")
...
def change_values(file):
    ...
    with open(file, 'w') as f:
        f.writelines(lines)
        print('[+] La cámara 0 y la consola se han activado con éxito.')
