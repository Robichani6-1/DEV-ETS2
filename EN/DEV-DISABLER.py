...
print('DEV-DISABLER: By Robichani6-1 (Transportes Chancleta)')
yes = ["sí", "si", "s", "y", "yes"]
no = ["no", "n"]
response = input("Do you want turn off camera 0 and console? (Y/N)")
...
def change_values(file):
    ...
    with open(file, 'w') as f:
        f.writelines(lines)
        print('[+] Camera 0 and the console have been successfully disabled.')
